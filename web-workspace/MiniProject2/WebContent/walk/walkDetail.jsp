...
<script>
	...
	function getIt(data) {
		...
		for (var i = 0; i < list.length; i++) {
			...
			if(id == 'shook88@naver.com' || id == "${sessionScope.userVO.nickname}" || "${sessionScope.userVO.type}"=='S')
				{
			...
			<table class="ajax" style="width:100%">
				<c:forEach items="${reply }" var="reply">
					<tr>
						...
						<td><c:if test="${ (reply.id eq 'shook88@naver.com')or(userVO.nickname eq reply.id) or (sessionScope.userVO.type eq 'S') }">
