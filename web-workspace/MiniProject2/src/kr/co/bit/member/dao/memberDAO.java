...
public class memberDAO {
	...
	public memberVO selectById(String id) {
		...
		StringBuilder sql = new StringBuilder();
		sql.append(
				" select id, name, password, nickname, sex, petNo, tel, basic_addr, type, point, date_format(reg_date, '%Y-%m-%d') as reg_date from t_member where id = ? ");
	...
	public memberVO login(String id, String password) {
		...
		StringBuilder sql = new StringBuilder();
		sql.append(
				"select id, name, password, nickname, sex, petNo, tel, basic_addr, type, point, date_format(reg_date, '%Y-%m-%d') as reg_date from t_member where id=? and password=?");
	...
	public void modifyMember(memberVO member) {
		...
		StringBuilder sql = new StringBuilder();
		sql.append(
				"update t_member set name=?, password=?, nickname=?, petNo=?, sex=?, tel=?, basic_addr=? where id=?");
