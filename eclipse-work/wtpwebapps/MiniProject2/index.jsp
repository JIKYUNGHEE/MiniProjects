...
<html>
  ...
  <body>
    ...
    <div class="container">
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              <img class="d-block img-fluid w-100" src="/MiniProject2/Resources/img/slide-1.jpg" alt="">
            ...
            <div class="carousel-item">
              <img class="d-block img-fluid w-100" src="/MiniProject2/Resources/img/slide-2.jpg" alt="">
              <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
              <img class="d-block img-fluid w-100" src="/MiniProject2/Resources/img/slide-3.jpg" alt="">
              <div class="carousel-caption d-none d-md-block">
      ...
      <div class="bg-faded p-4 my-4">
        <hr class="divider">
        <h2 class="text-center text-lg text-uppercase my-0">Our goal is to help end pet overpopulation and 
          <strong>strengthen the bond between people and their pets.</strong>
        </h2>
        <hr class="divider">
